...
public class ActualProjectTask
{
    ...
    {
        #region DB functions
        string query = "select ats.status_id, at.id, at.title, at.description, at.start_date, at.end_date, at.assign_to, e.first_name, apt.project_id project_id from actual_tasks at " +
